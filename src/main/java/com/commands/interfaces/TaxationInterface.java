...
public class TaxationInterface extends CommandBase {
    ...
    public void handleButtonClick(ButtonInteractionEvent event) {
        ...
        event.replyEmbeds(embed.build())
                .addActionRow(
                        ...
                        Button.primary("t_increase5", "🔼 Increase by 5%"),
                        Button.primary("t_decrease5", "🔽 Decrease by 5%"),
                        Button.primary("t.tax_main", "🏰 Back to com.Main Menu")
                )
                .queue();
    }
