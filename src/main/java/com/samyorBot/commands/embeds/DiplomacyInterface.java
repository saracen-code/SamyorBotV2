...
public class DiplomacyInterface implements ICommand {
    ...
    public String getDescription() {
        return "Take diplomatic actions and deal and negotiate between entities.";
    }
    ...
    public void execute(SlashCommandInteractionEvent event) {
        sendDiplomacyIntro(event.getChannel(), event.getUser());
    }
     ...
     **/
    public static void sendDiplomacyIntro(MessageChannel channel, User author) {
     ...
     */
    private static void sendCountrySelectionModal(ButtonInteractionEvent event) {
    ...
    } // sendCountrySelectionModal

    /**
     * Displays available diplomatic actions.
     */
    private static void sendDiplomaticActions(ButtonInteractionEvent event) {
