...
public class TravelInterface extends ListenerAdapter implements WorkingCommand {
    public static Color interfaceColor = Color.decode("#777311");

    @Override
    public void execute(MessageReceivedEvent event) {
        sendTravelMenu(event.getChannel());
    }
    ...
    public static void sendTravelMenu(MessageChannel channel) {
        ...
        // Use emojis and primary button colors for aesthetics
    ...
    public static void sendTravelActions(ButtonInteractionEvent event) {
        ...
        event.replyEmbeds(embed.build()).addActionRow(moveButton, itineraryButton, nearbyButton, backButton).queue();
    }
    ...
    public static void sendEntourage(ButtonInteractionEvent event) {
        ...
        event.replyEmbeds(embed.build()).addActionRow(mercenariesButton, armiesButton, caravansButton, backButton).queue();
    }
