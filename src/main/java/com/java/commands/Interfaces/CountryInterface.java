...
public class CountryInterface extends ListenerAdapter implements WorkingCommand {
    public void getData(MessageReceivedEvent event) {
    ...
    public void execute(MessageReceivedEvent event) {
        sendCountryIntroPage(event.getChannel());
    }
    ...
    public static void sendCountryIntroPage(MessageChannel channel) {
        ...
        Button censusButton = Button.primary("request_census", "Conduct Census");
        Button taxButton = Button.primary("call_tax_interface", "Manage Taxes");
        Button diplomacyButton = Button.primary("call_diplomacy_interface", "Diplomacy");
        Button decreeButton = Button.primary("public_decree", "Public Decrees");

        channel.sendMessageEmbeds(embed.build())
                .setActionRow(censusButton, taxButton, diplomacyButton, decreeButton)
                .queue();
    }
    ...
    public static void callDiplomacyInterface(ButtonInteractionEvent event) {
        ...
        DiplomacyInterface.sendDiplomacyIntro(event.getChannel()); // Assuming sendDiplomacyInterface is your existing method for diplomacy
    }
