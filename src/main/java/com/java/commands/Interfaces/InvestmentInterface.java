...
public class InvestmentInterface implements WorkingCommand {

    // Entry point for the investment interface
    @Override
    public void execute(MessageReceivedEvent event) {
        sendInvestmentIntro(event.getChannel());
    }

    // Intro Page for Investment Interface
    public static void sendInvestmentIntro(MessageChannel channel) {
        EmbedBuilder embed = new EmbedBuilder()
                .setColor(Color.GREEN) // Use appropriate color here
